...
import Label.*;
//确认事件抽取
public class IrrelevantLabelAction extends ActionSupport implements Action{
	...
	public String execute() throws Exception {
		...
		/*if(eventType==21)//not event
			...
			item = new LabelItem(label.labelID, dbname, newsid, label.newsTitle,
				...
				eventLocation);
		*/
		LabelItem item = new LabelItem(label.labelID, dbname, newsid, label.newsTitle);
		connectLabelDB.IrrelevantLabel(item, username);
		return this.SUCCESS;
	}
}
